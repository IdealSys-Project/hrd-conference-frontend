...
const Speakers: React.FC = () => {
  const speakers = [
    ...
    },
    {
      ...
      companyLogo: '/assets/images/speakers/company-logos/The_Growth_Perspective_logo_2.png',
    ...
    },
    {
      ...
      companyLogo: '/assets/images/speakers/company-logos/Laurea_People_Signature_logo_4.png',
    ...
    },
    {
     ...
     {
      id: 33,
      name: 'Usha Gunasegaran',
      position: "Human Resource Director, Asia Pacific Region",
      company: "Speedcast",
      image: '/assets/images/speakers/speaker-images/Speedcast_speaker_2_crop.png',
      companyLogo: '/assets/images/speakers/company-logos/Speedcast_logo.png',
      linkedIn: 'https://www.linkedin.com/in/usha-gunasegaran/',
      bio: "With over 20 years of HR leadership experience across diverse industries, I serve as Director of Human Resources, Asia Pacific for Speedcast, driving HR transformation as a strategic enabler of business success. My expertise spans employee and industrial relations, talent development, HR analytics, and compliance. I partner with leaders across APAC to align people strategies with business goals, leveraging data and technology to optimize talent. Passionate about inclusive, high-performing cultures, I champion leadership development, employee engagement, and continuous learning. My focus is on future-proofing organizations through agile change management and innovative HR practices that empower people and elevate organizational excellence.",
    },
  ];
