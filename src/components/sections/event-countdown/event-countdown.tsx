            ...
            <div className="col-lg-10">
              <div id="countdown-timer">
                <div className="countdown-item" id="days-item">
                  ...
                  <div className="countdown-label" id="days-label">
                    Days
                  </div>
                </div>
                <div className="countdown-item" id="hours-item">
                  ...
                  <div className="countdown-label" id="hours-label">
                    Hours
                  </div>
                </div>
                <div className="countdown-item" id="minutes-item">
                  ...
                  <div className="countdown-label" id="minutes-label">
                    Minutes
                  </div>
                </div>
                <div className="countdown-item" id="seconds-item">
                  ...
                  <div className="countdown-label" id="seconds-label">
                    Seconds
                  </div>
                </div>
              </div>
                ...
                >
                  <motion.span
                    ...
                    whileHover={{
                      ...
                      background:
                        'linear-gradient(135deg, rgba(60, 90, 180, 0.9) 0%, rgba(140, 20, 220, 0.9) 100%)',
                    }}
                  >
                    AI
                  </motion.span>
